...
Dose: $\bar x=`r mean(dose)`$ mg, $s_x^2=`r var(dose)`$ mg$^2$, $s_x=`r stdev(dose)`$ mg.<br/>
Days: $\bar y=`r mean(days)`$ days, $s_y^2=`r var(days)`$ days$^2$, $s_y=`r stdev(days)`$ days.<br/>
3. $s_{xy}=`r cov(dose,days)`$ mg$\cdot$days.
</div>
...
c <- coefficients(m)
```
$\bar x=`r mean(x)`$ mg/dl, $s_x^2=`r var(x)`$ (mg/dl)$^2$.<br/>
$\bar y=`r mean(y)`$ mmHg, $s_y^2=`r var(y)`$ mmHg$^2$.<br/>
$s_{xy}=`r cov(x,y)`$ mg/dl$\cdot$mmHg.<br/>
...
<div><button class="solution">Show solution</button></div>
<div id="solution" style="display: none">
1. $\bar x=`r mean(x)`$ years, $s_x^2=`r var(x)`$ years$^2$.<br/>
$\bar y=`r mean(y)`$ %, $s_y^2=`r var(y)`$ %$^2$.<br/>
$s_{xy}=`r cov(x,y)`$ years$\cdot$%.<br/>
...
<div><button class="solution">Show solution</button></div>
<div id="solution" style="display: none">
1. $\bar x=`r mean(x)`$ min, $s_x^2=`r var(x)`$ min$^2$.<br/>
$\bar y=`r mean(y)`$ injuries, $s_y^2=`r var(y)`$ injuries$^2$.<br/>
$s_{xy}=`r cov(x,y)`$ min$\cdot$injuries.<br/>
...
$s_{xy}=`r cov(x,y)`$ years$\cdot$kg.<br/>
$r^2=`r summary(m)$r.squared`$.<br/>
2. $\bar x=`r mean(x1)`$ years, $s_x^2=`r var(x1)`$ years$^2$.<br/>
$\bar y=`r mean(y1)`$ kg, $s_y^2=`r var(y1)`$ kg$^2$.<br/>
$s_{xy}=`r cov(x1,y1)`$ years$\cdot$kg.<br/>
$r^2=`r summary(m1)$r.squared`$.<br/>
3. $\bar x=`r mean(x2)`$ years, $s_x^2=`r var(x2)`$ years$^2$.<br/>
$\bar y=`r mean(y2)`$ kg, $s_y^2=`r var(y2)`$ kg$^2$.<br/>
$s_{xy}=`r cov(x2,y2)`$ years$\cdot$kg.<br/>

...
1. $PPV=P(D|+)=`r (p*sen1)/(p*sen1+(1-p)*(1-spe1))`$. It is not a goot test to confirm the sciatica as the post test probability of having the sciatica for a positive outcome is very low. <br/>

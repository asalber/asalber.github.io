...
![](featured.png){.post-featured-image fig-alt="Curso de Git"}
...
- [Manual de Git](https://aprendeconalf.es/manual-git)
- [Ejercicios de Git](https://aprendeconalf.es/docencia/git/ejercicios/)

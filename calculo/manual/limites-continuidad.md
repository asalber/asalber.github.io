...
-   **Tipo producto**. Si $$\lim_{x\rightarrow a} f(x)=0$$ y $$\lim_{x\rightarrow a} g(x)=\pm\infty$$, entonces $f(x)\cdot g(x)$
    presenta una indeterminación del tipo $0\cdot \pm\infty$ cuando $x\rightarrow a$.
